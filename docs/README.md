...
Bem-vindo à documentação técnica oficial do `@raicampos/query-toolkit`. Este repositório fornece uma biblioteca robusta, extensível e de alto desempenho projetada em TypeScript para simplificar o ecossistema de dados das suas aplicações.
...
O design do `@raicampos/query-toolkit` é firmemente ancorado nos conceitos de **Clean Architecture** e **Clean Code**:
